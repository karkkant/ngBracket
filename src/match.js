 ...
 */
myApp.directive('match', ['connectorService', 'positioningService', 'data', '$filter', 'highlight', 'matchDetailService',
	function(connectorService, positioningService, data, $filter, highlight, matchDetailService) {
		return {
			restrict: "E",
			scope: false,
			...
			link: function(scope, el, attrs) {
				...
				scope.showDetails = function($event) {
					...
					matchDetailService.showDetails($event.target, {
